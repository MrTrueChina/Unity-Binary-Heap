...
public class MinBinaryHeapTest
{
    ...
    public void RemoveFirstThroughValue_Normal_Null()
    {
        ...
        heap.RemoveFirstThroughValue(6);
        ...
        heap.RemoveFirstThroughValue(5);
        ...
        heap.RemoveFirstThroughValue(199);
    ...
    [Test]
    public void RemoveFirstThroughObj_Normal_Null()
    {
        ...
        List<MinBinaryHeapNode<int>> nodes = heap.GetNodes();


        heap.RemoveFirstThroughObj(6);
    ...
    public void ContainsValue_CanFind()
    {
        ...
        Assert.IsTrue(heap.ContainsValue(0));
        Assert.IsTrue(heap.ContainsValue(1));
        Assert.IsTrue(heap.ContainsValue(2));
        Assert.IsTrue(heap.ContainsValue(3));
        Assert.IsTrue(heap.ContainsValue(4));
        Assert.IsTrue(heap.ContainsValue(5));
        Assert.IsTrue(heap.ContainsValue(6));
    }
    [Test]
    public void ContainsValue_CantFind()
    {
        ...
        Assert.IsFalse(heap.ContainsValue(10));
        Assert.IsFalse(heap.ContainsValue(11));
        Assert.IsFalse(heap.ContainsValue(12));
        Assert.IsFalse(heap.ContainsValue(13));
        Assert.IsFalse(heap.ContainsValue(14));
        Assert.IsFalse(heap.ContainsValue(15));
        Assert.IsFalse(heap.ContainsValue(16));
    }
    ...
    public void FindFirstThroughValue_CanFind()
    {
        ...
        Assert.AreEqual("zero", heap.FindFirstThroughValue(0));
    }
    [Test]
    public void FindFirstThroughValue_CantFind()
    {
        ...
        Assert.AreEqual(null, heap.FindFirstThroughValue(7));
    }
